<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="处方类型" prop="prescriptionType">
        <el-select v-model="queryParams.prescriptionType" placeholder="请选择处方类型" clearable>
          <el-option
            v-for="dict in dict.type.pill_grug_pt"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="drugList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药品名称" align="center" prop="drugName" min-width="150" />
      ...
      <el-table-column label="处方类型" align="center" prop="prescriptionType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.pill_grug_pt" :value="scope.row.prescriptionType"/>
        </template>
      </el-table-column>
...
export default {
  name: "Drug",
  dicts: ['pill_grug_pt', 'pill_drug_dt', 'sys_normal_disable'],
  data() {
    return {
      // 遮罩层
      loading: true,
